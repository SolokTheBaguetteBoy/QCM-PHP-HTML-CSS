				  ...
				  <div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="myNavbar">
					  <ul class="nav navbar-nav">
						...
						<li class="dropdown">
						  <a class="dropdown-toggle" data-toggle="dropdown" href="#">QCM <span class="caret"></span></a>
						  <ul class="dropdown-menu">
							<li><a href="index.php?controle=utilisateur&action=CreerTest">Création Test</a></li>
							<li><a href="index.php?controle=utilisateur&action=VoirTest">Gestion Test</a></li>
						  </ul>
						</li>
